...
date: 2026-01-26
abstract: |
  We investigate how to regulate the current or voltage supplied to a laser diode, how to measure the output light intensity with a photodiode, and how to characterize the variation in light intensity using a graphical dc voltmeter. 
---

# Setup and Introduction 

In our main experiment today, we will use a diode laser emitting 650 nm red light in combination with a photodiode-based photodetector measuring  light intensity to study light transmission as a function of polarizer angle.  This is an interesting measurement on its own but it is also the first step in investigating Faraday rotation: using a magnetic field to change the polarization angle of polarized light [^Faraday_rotation]. 

IN this preliminary set of experiments, however, we must first investigate how to optimize our measurements by 

1. learning how to regulate the dc power provided to the diode,
2. learning how to measure the output light intensity with a photodiode, and
3. learning how to characterize the variation in light intensity using a graphical dc voltmeter. 
